...
export class Button extends HTMLElement {
  ...
  constructor() {
    ...
    shadow.append(BUTTON_TEMPLATE.content.cloneNode(true));
    this.button = shadow.querySelector("button")!;
  }

  connectedCallback() {
    this.dataset.component = BUTTON_TAG;
    this.syncAttributes();
  }
...
export function defineButton() {
  ...
  customElements.define(BUTTON_TAG, Button);
}
